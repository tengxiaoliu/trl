...
config = PPOConfig(model_name="lvwerra/t5-imdb", learning_rate=5e-5, batch_size=8, forward_batch_size=1)
...
for epoch, batch in tqdm(enumerate(ppo_trainer.dataloader)):
    ...
    #### Run PPO step
    print(f"text: {texts}")
    print(f"query_tensors: {query_tensors[0].shape, query_tensors[0]}")  # batch * query_len
    print(f"response_tensors: {response_tensors[0].shape, response_tensors[0]}")  # batch * response_len
    print(f"rewards: {rewards[0].shape, rewards[0]}")  # batch
